 ...
 * Feature编解器(线程安全)<br/>
 * <p/>
 * 用于封装系统内部features/attribute等扩展字段的管理;2015-03-31
...
public class FeatureCodec {
    ...
    private String escapeDecode(String string) {
        ...
        for (int index = 0; index < stringLength; index++) {
            ...
            if (Objects.equals(c, ESCAPE_PREFIX_CHAR)
    ...
    private String[] escapeSplit(String string, char splitEscapeChar) {
        ...
        for (int index = 0; index < stringLength; index++) {
            ...
            // 匹配到分割符
            else if (Objects.equals(c, splitEscapeChar)) {
                isArchive = true;
            }
    ...
    public static final FeatureCodec codec = new FeatureCodec();
