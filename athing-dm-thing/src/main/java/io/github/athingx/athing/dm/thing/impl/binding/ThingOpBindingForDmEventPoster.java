...
public class ThingOpBindingForDmEventPoster implements ThingOpBinding<ThingOpCaller<ThingDmEvent<?>, OpReply<Void>>> {

    private final ThingDmOption option;

    public ThingOpBindingForDmEventPoster(ThingDmOption option) {
        this.option = option;
    }
