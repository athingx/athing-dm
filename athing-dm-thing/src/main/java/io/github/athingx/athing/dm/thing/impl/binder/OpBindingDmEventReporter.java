...
public class OpBindingDmEventReporter implements OpBinding<ThingOpCaller<ThingDmEvent<?>, OpReply<Void>>> {

    private final ThingDmOption option;

    public OpBindingDmEventReporter(ThingDmOption option) {
        this.option = option;
    }
