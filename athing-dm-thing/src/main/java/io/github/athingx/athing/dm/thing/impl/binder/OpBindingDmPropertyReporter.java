...
public class OpBindingDmPropertyReporter implements OpBinding<ThingOpCaller<Map<Identifier, Object>, OpReply<Void>>> {

    private final ThingDmOption option;

    public OpBindingDmPropertyReporter(ThingDmOption option) {
        this.option = option;
    }
