...
public class ThingOpBindingDmPropertyPoster implements ThingOpBinding<ThingOpCaller<Map<Identifier, Object>, OpReply<Void>>> {

    private final ThingDmOption option;

    public ThingOpBindingDmPropertyPoster(ThingDmOption option) {
        this.option = option;
    }
